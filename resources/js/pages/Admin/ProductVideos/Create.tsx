...
export default function Create({ product, providers }: CreateProps) {
  ...
  const onSubmit = (data: FormValues) => {
    ...
    Inertia.post(route('product-videos.store', product.id), formData, {
      forceFormData: true,
    });
  };
  ...
  const handleThumbnailChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      // For example, you can set the file to the form state if needed
    }
  };
          ...
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <CardFooter className="flex justify-end px-0 pb-0">
                  ...
                  >
                    {formState.isSubmitting ? 'Adding...' : 'Add Video'}
                  </Button>
                </CardFooter>
              </form>           
          </CardContent>
