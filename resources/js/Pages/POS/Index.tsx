              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <Button 
                      onClick={search} 
                      className="h-12 px-6 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white shadow-md"
                    >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Button 
                    ...
                    className={`h-12 w-full transition-all duration-200 shadow-md ${
                      cameraEnabled 
