          ...
          <div className="max-w-7xl mx-auto px-6 py-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg text-blue-600">Real-time insights and analytics</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-blue-100 text-sm font-medium uppercase tracking-wide">Today's Sales</p>
                    <p className="text-3xl font-bold">₹{metrics?.sales?.today?.toLocaleString() || '0'}</p>
            ...
            <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-green-100 text-sm font-medium uppercase tracking-wide">Today's Orders</p>
                    <p className="text-3xl font-bold">{metrics?.orders?.today || 0}</p>
                    <div className="flex items-center mt-2">
            ...
            <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-purple-100 text-sm font-medium uppercase tracking-wide">Total Customers</p>
                    <p className="text-3xl font-bold">{metrics?.customers?.total?.toLocaleString() || '0'}</p>
                    <div className="flex items-center mt-2">
            ...
            <Card className="bg-gradient-to-br from-orange-500 to-red-500 text-white border-0 shadow-lg">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-orange-100 text-sm font-medium uppercase tracking-wide">Inventory Alerts</p>
                    <p className="text-3xl font-bold">{(metrics?.products?.low_stock || 0) + (metrics?.products?.out_of_stock || 0)}</p>
                    <div className="flex items-center mt-2">
                ...
                <div className="grid grid-cols-2 gap-4 h-80">
                  <div className="space-y-4">
                    ...
                    <div className="bg-red-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-red-800">Refunds</h4>
