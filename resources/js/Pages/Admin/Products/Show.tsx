...
import { Pencil, ArrowLeft, Image, ListChecks, Video, Printer } from 'lucide-react';
interface product {
  id: number;
  name: string;
  slug: string;
                ...
                <TableRow>
                  ...
                  <TableCell className="flex items-center gap-3">
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handlePrint(route('products.barcode', product.id))}
                      className="h-7 gap-1"
                    >
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handlePrint(route('products.qr', product.id))}
                      className="h-7 gap-1"
                    >
                      <Printer className="h-3 w-3" />
                      Print QR
