...
const Create: React.FC = () => {
  ...
  const { data, setData, post, processing, errors } = useForm<AboutUsForm>({
    page_title: '',
    description: '',
    image: null,
    status: 'active',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('aboutus.store'), { forceFormData: true });
  };
  ...
  return (
    <DashboardLayout title="Create About Us">
      <Head title="Create About Us" />
      <div className="space-y-4 pb-6">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-semibold">Create About Us</h1>
        </div>
      </div>
      <Card>
        <CardHeader>
