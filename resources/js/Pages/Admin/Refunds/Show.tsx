      ...
      <div className="space-y-6">
        ...
        {showApproveForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg border shadow-lg w-full max-w-md">
              ...
              <div className="p-6 pt-0 space-y-4">
                <div>
                  <Label htmlFor="admin_notes" className="text-gray-900 dark:text-gray-100">
        ...
        {showRejectForm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg border shadow-lg w-full max-w-md">
              ...
              <div className="p-6 pt-0 space-y-4">
                <div>
                  <Label htmlFor="rejection_reason" className="text-gray-900 dark:text-gray-100">
                    Rejection Reason *
                  </Label>
                  <Textarea
                    id="rejection_reason"
                ...
                <div>
                  <Label htmlFor="admin_notes_reject" className="text-gray-900 dark:text-gray-100">
                    Admin Notes (Optional)
                  </Label>
                  <Textarea
